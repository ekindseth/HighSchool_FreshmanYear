...
Public Class Form1
    ...
    Private Sub btnCalculate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCalculate.Click
        ...
        lblNbrDollars.Text = intdollar.ToString
        intquarters = intpennies \ 25
        intpennies = intpennies - intquarters * 25
        lblNbrQuarters.Text = intquarters.ToString
        intdimes = intpennies \ 10
        intpennies = intpennies - intdimes * 10
        lblNbrDimes.Text = intdimes.ToString
        intnickels = intpennies \ 5
        intpennies = intpennies - intnickels * 5
        lblNbrNickels.Text = intnickels.ToString
        lblNbrPennies.Text = intpennies.ToString
